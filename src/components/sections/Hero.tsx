...
const buttonVariants = {
  ...
  hover: {
    ...
    rotateX: 8,
    boxShadow:
      '0 8px 32px 0 rgba(59,130,246,0.25), 0 0 16px 2px rgba(59,130,246,0.15)',
...
const Hero = () => {
  ...
  React.useEffect(() => {
    import('react-typewriter-effect').then((mod) =>
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-white to-gray-50 overflow-hidden"
    >
      ...
      >
        <div className="w-full max-w-4xl mx-auto flex flex-col items-center text-center">
          ...
          >
            Designing reliable web applications and automating cloud
            infrastructures.
          </motion.p>
