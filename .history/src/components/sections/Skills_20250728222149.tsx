...
import {
    SiNodeDotJs, SiPython, SiJava, SiExpress, SiFastapi, SiSpringboot, SiPostgresql, SiMysql, SiMongodb, SiGraphql,
    SiDocker, SiKubernetes, SiGooglecloud, SiCicd, SiGithubactions, SiArgo, SiPrometheus, SiGrafana,
    SiReact, SiNextdotjs, SiTypescript, SiJavascript, SiHtml5, SiCss3, SiTailwindcss,
    SiGit, SiLinux, SiNginx, SiMicrodotblog
} from "react-icons/si";
...
const skillIconMap: Record<string, { icon: React.ReactNode; color: string; label: string }> = {
    ...
    "Java": { icon: <SiJava />, color: "bg-blue-100 text-blue-600", label: "Java" },
    ...
    "CI/CD": { icon: <SiCicd />, color: "bg-green-100 text-green-600", label: "CI/CD" },
