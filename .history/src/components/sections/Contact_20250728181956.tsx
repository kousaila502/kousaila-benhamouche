                            ...
                            <div className="space-y-4">
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">k.benhamouche@esi-sba.dz</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">Oran, Algeria</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">+213 662942408</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex space-x-4">
                                {socialLinks.map((social) => (
                                    <a
                                        ...
                                        className={`w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center text-gray-600 transition-all duration-200 transform hover:scale-110 ${social.color}`}
                        ...
                        {submitted ? (
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <button
                                    ...
                                    className="w-full bg-blue-600 text-white py-4 px-6 rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-semibold text-lg"
                                >
