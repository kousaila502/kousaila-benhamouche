                ...
                >
                    <motion.div variants={itemVariants} className="text-center mb-12">
                        ...
                        <h2 className="text-4xl font-black text-gray-900 mb-3">
                            Enterprise FastAPI Systems
                        </h2>
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            Production microservices with real users, revenue generation, and 99.9% uptime
                        </p>
                    </motion.div>
                    ...
                    <div className="relative bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 rounded-3xl p-8 md:p-12 overflow-hidden">
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <div className="flex flex-wrap justify-center gap-4">
                                ...
                                <a
                                    href="https://ecommerce-app-omega-two-64.vercel.app"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-3 px-8 py-4 bg-white/10 border-2 border-white/20 text-white rounded-xl font-bold text-lg hover:bg-white/20 transition-all duration-200 backdrop-blur-sm group"
                                >
