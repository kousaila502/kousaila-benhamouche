...
const techIconMap: Record<string, { icon: React.ReactNode; color: string }> = {
    ...
    "Java": { icon: <span className="font-bold">☕</span>, color: "text-orange-600" },
    ...
    const productionMicroservices = [
        {
            ...
            description: "Enterprise-grade authentication microservice serving 17+ active users with JWT, role-based access control, and real-time admin dashboard.",
        ...
        },
        {
            ...
            description: "Comprehensive order processing system with real-time analytics. Currently processing $1,593.95 in revenue with 9 completed orders.",
        ...
        },
        {
            ...
            description: "Comprehensive product catalog management with MongoDB Atlas, advanced search, inventory tracking, and deals management for e-commerce platform.",
            technologies: ["Node.js", "Express.js", "MongoDB", "Mongoose", "Heroku", "Docker", "JWT", "Swagger", "CI/CD"],
            metrics: {
                endpoints: "20+",
            ...
            links: {
                live: "https://ecommerce-product-service-56575270905a.herokuapp.com",
                github: "https://github.com/kousaila502/products-microservice",
                health: "https://ecommerce-product-service-56575270905a.herokuapp.com/health"
            },
        ...
        },
        {
            ...
            description: "High-performance reactive cart management with Spring WebFlux, Redis session storage, real-time synchronization, and seamless checkout integration.",
            technologies: ["Java", "Spring Boot", "WebFlux", "Redis", "Upstash", "Heroku", "JWT", "Reactive Programming"],
            metrics: {
            ...
            links: {
                ...
                health: "https://ecommerce-cart-service-f2a908c60d8a.herokuapp.com/health"
            },
    ...
    const fullStackProjects = [
        {
            ...
            description: "Complete digital platform for managing social welfare programs with role-based access control, budget allocation, and payment processing.",
            technologies: ["React", "TypeScript", "Node.js", "Express.js", "MongoDB", "JWT Auth", "Tailwind CSS", "Vite"],
            features: ["4 User Roles", "8-Stage Workflow", "Real-time Updates", "Algerian Localization"],
            links: {
        ...
        },
        {
            ...
            features: ["5 Cloud Providers", "60% Cost Reduction", "100% GitOps", "Real Users"],
            links: {
    ...
    const backendProjects = [
        {
            ...
            description: "Production-ready REST API for Algerian tourism with authentication, file handling, and role management.",
            technologies: ["Node.js", "Express.js", "MongoDB", "JWT", "Swagger"],
            features: ["60% Code Reduction", "Complete Auth System", "File Uploads", "API Documentation"],
            links: {
        ...
        },
        {
            ...
            description: "Complete enterprise management solution with React frontend, Node.js backend, and MySQL integration.",
            technologies: ["React", "Node.js", "MySQL", "Express.js"],
            features: ["Full-Stack Solution", "Enterprise Architecture", "Database Integration", "Modern UI/UX"],
            links: {
    ...
    const devopsProjects = [
        {
            ...
            description: "Advanced infrastructure automation achieving $3,660 annual savings through intelligent resource management.",
            technologies: ["Kubernetes", "Docker", "Terraform", "Prometheus", "Grafana", "Cloud Platforms"],
            features: ["80% Cost Reduction", "95% Automation", "Multi-Cloud", "Research Thesis"],
            links: {
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <motion.div variants={itemVariants} className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            Four live microservices with real users, revenue generation, and 99.9% uptime
                        </p>
                    </motion.div>
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-6">
                                        {project.technologies.slice(0, 6).map((tech, techIndex) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    {techInfo && (
                                                        <span className={`${techInfo.color}`}>{techInfo.icon}</span>
                                                    )}
                                                    {tech}
                                                </span>
                                            );
                ...
                >
                    <motion.div variants={itemVariants} className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            End-to-end platforms with modern architecture and real-world impact
                        </p>
                    </motion.div>
                                    ...
                                    <div className="flex flex-wrap gap-1 mb-4">
                                        {project.technologies.slice(0, 5).map((tech, techIndex) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    {techInfo && (
                                                        <span className={`text-sm ${techInfo.color}`}>{techInfo.icon}</span>
                                                    )}
                                                    {tech}
                                                </span>
                                            );
                        ...
                        {[...backendProjects, ...devopsProjects].map((project, index) => (
                            ...
                            >
                                ...
                                <div className="p-4">
                                    ...
                                    <p className="text-orange-600 font-semibold mb-2 text-sm">{project.subtitle}</p>
                    ...
                    <div className="relative bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 rounded-3xl p-8 md:p-12 overflow-hidden">
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
                                Experience <span className="font-bold text-green-400">4 live microservices</span> processing <span className="font-bold text-green-400">$1,593.95</span> in 
                                actual revenue, serving <span className="font-bold text-blue-400">17+ active users</span> with 
                                <span className="font-bold text-purple-400"> 99.9% uptime</span> across multiple technologies.
                            </p>

                            {/* Stats Grid */}
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
                                <div className="text-center">
                                    <div className="text-3xl font-black text-green-400 mb-2">$1,593.95</div>
                                    <div className="text-sm text-gray-400">Revenue Processed</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-3xl font-black text-blue-400 mb-2">17+</div>
                                ...
                                <div className="text-center">
                                    <div className="text-3xl font-black text-orange-400 mb-2">60%</div>
                            ...
                            <div className="mt-12 pt-8 border-t border-white/10">
                                <p className="text-gray-400 text-sm mb-4">Powered by modern technology stack</p>
