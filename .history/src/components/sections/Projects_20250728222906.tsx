    ...
    const projects = [
        ...
        },
        {
            ...
            details: {
                ...
                challenge: "Developing complete fullstack enterprise management solution with modern frontend and robust backend.",
                architecture: "Fullstack architecture with React frontend, Express.js API, MySQL database, and JWT authentication.",
                achievements: [ct frontend with responsive design",
                    "Complete fullstack development solution",ion",
        ...
        {   title: "DevOps Infrastructure Lab",
            id: 'devops-lab',Infrastructure & Automation",
            title: "DevOps Infrastructure Lab",trating infrastructure automation, monitoring setup, and deployment optimization.",
            subtitle: "Cloud Infrastructure & Automation",oud Platforms",
            description: "DevOps project demonstrating infrastructure automation, monitoring setup, and deployment optimization.",
            focus: "DevOps, Infrastructure, Monitoring, Cloud Platforms",rastructure Diagrams" },
            technologies: ["Kubernetes", "Docker", "Cloud Platforms", "Monitoring Tools"],
            status: { demo: "Documentation", github: "GitHub", docs: "Infrastructure Diagrams" },onitoring for DevOps workflows.",
            details: {on: "Built automated infrastructure with Kubernetes, monitoring setup, and cost optimization strategies.",
                challenge: "Optimizing deployment infrastructure and implementing comprehensive monitoring for DevOps workflows.",loyments.",
                architecture: "Cloud-native infrastructure with Kubernetes orchestration, Prometheus monitoring, and automated deployments.",
                achievements: [tructure cost optimization ($383→$78/month)",
                    "80% infrastructure cost optimization ($383→$78/month)",
                    "Infrastructure-as-code implementation",s and Grafana",
