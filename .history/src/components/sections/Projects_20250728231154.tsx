...
import {
    SiDocker, SiKubernetes, SiPython, SiNodedotjs, SiExpress, SiFastapi, SiSpringboot, SiReact, SiMongodb, SiMysql, SiPostgresql, SiGraphql, SiGithub, SiSwagger, SiIcloud, SiJet
} from "react-icons/si";
...
const techIconMap: Record<string, { icon: React.ReactNode; label: string }> = {
    ...
    "REST APIs": { icon: <span className="font-bold text-lg">API</span>, label: "REST APIs" }, // Placeholder for REST APIs
    ...
    "CI/CD": { icon: <SiIcloud />, label: "CI/CD" }, // Use SiIcloud as a cloud/CI/CD icon
    "React": { icon: <SiReact />, label: "React" },
    "JWT": { icon: <SiJet />, label: "JWT" }, // Use SiJet as a placeholder for JWT
                            ...
                            >
                                ...
                                <div className="flex-1 flex flex-col justify-between p-8">
                                    ...
                                    <div className="flex flex-wrap gap-3 mt-2">
                                        ...
                                        {/* Status badges */}
                                        {Object.entries(project.status).map(([key, value], _) => (
                                            <span
                                                key={key}
