            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-3">
                                {category.skills.map((skill, skillIndex) => (
                                    <span
                                        key={skillIndex}
                                        className={`px-4 py-2 rounded-full text-sm font-medium border transition-all hover:scale-105 hover:shadow-md ${category.color}`}
                                    >
                                        {skill}
                                    </span>
                                ))}
                    ...
                    <div className="text-center">
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            {[
                                ...
                                <span
                                    key={index}
                                    className="px-6 py-3 bg-white bg-opacity-20 rounded-full text-lg font-medium backdrop-blur-sm"
                                >
                                    {specialty}
                                </span>
                            ))}
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                    <div className="bg-white rounded-xl p-8 shadow-lg">
                        <div className="text-4xl font-bold text-primary-600 mb-2">5.1x</div>
