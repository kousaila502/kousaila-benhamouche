...
import {
    SiDocker, SiKubernetes, SiPython, SiNodedotjs, SiExpress, SiFastapi, SiSpringboot, SiReact, SiMongodb, SiMysql, SiPostgresql, SiGraphql, SiGithub, SiSwagger, SiCloud, SiJwt, SiApi
} from "react-icons/si";
...
const techIconMap: Record<string, { icon: React.ReactNode; label: string }> = {
    ...
    "Java": { icon: <span className="font-bold text-lg">J</span>, label: "Java" }, // Placeholder for Java
    ...
    const projects = [
        ...
        },
        {
            ...
            details: {
                ...
                solution: "Created end-to-end appl                challenge: "Developing complete fullstack enterprise management solution with modern frontend and robust backend.",de.j                               architecture: "Fullstack architecture with React frontend, Express.js API, MySQL database, and JWT authentication.",Fu                achievements: [ frontend, Express.js API, MySQL database, and JWT a                    "Complete fullstack development solution",         "Complet                    "Modern React frontend with responsive design",React frontend                     "Robust backend API with database integration",esign",
                     "Enterprise-scale architecture and security"      "Robust                ]PI            }abase integra        },                  "Enterprise-scale        {ture and security"
                ]
                      id: 'devops-lab',           id: 'devops-lab',
                        title: "DevOps Infrastructure Lab",  subtitle: "Cloud Infrastructure & Automation",
            description: "DevOps project dem            subtitle: "Cloud Infrastructure & Automation",d deployment optimization.",
             description: "DevOps project demonstrating infrastructure automation, monitoring setup, and deployment optimization.",nologies: ["K            focus: "DevOps, Infrastructure, Monitoring, Cloud Platforms",  status: { demo: "Documentation", g            technologies: ["Kubernetes", "Docker", "Cloud Platforms", "Monitoring Tools"], "Infrastruct            status: { demo: "Documentation", github: "GitHub", docs: "Infrastructure Diagrams" },structure and implementing comprehensive mon            details: {kflows.",
                solution: "Built automated infrastructure with Kubernetes, monitoring setup, and cost op                challenge: "Optimizing deployment infrastructure and implementing comprehensive monitoring for DevOps workflows.",itoring, and automa                   architecture: "Cloud-native infrastructure with Kubernetes orchestration, Prometheus monitoring, and automated deployments.",  achie                achievements: [ "80% infrastructure cost optimization ($383→$78/month                    "80% infrastructure cost optimization ($383→$78/month)",ana                                "Infrastructure-as-code implementation",a",on",
                    "Master's thesi                    "Master's thesis research with quantifiable results"ua                ]ults            }                }           }
     ];       }
    ];

    // Animation var    // Animation variantsants = {
       c        hidden: { opacity: 0, y: 40, scale: 0.97 },  show: { opacity: 1, y: 0, scale: 1, transition: { duration: 0.7, ease: [0.42, 0, 0.58, 1] as [number, number, number, number] } }
    };
