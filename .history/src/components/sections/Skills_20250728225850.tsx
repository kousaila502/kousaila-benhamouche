                    ...
                    {stats.map((stat, idx) => {
                        ...
                        return ({`rounded-xl p-8 shadow-lg border border-gray-100 bg-white/80 backdrop-blur-md hover:shadow-2xl transition-all duration-300 transform hover:scale-105 group`}
                            <motion.div     variants={cardVariants}
                                ...
                                className={`rounded-xl p-8 shadow-lg border border-gray-100 bg-white/80 backdrop-blur-md hover:shadow-2xl transition-all duration-300 transform hover:scale-105 group`}       boxShadow: `0 0 0 4px rgba(59,130,246,0.10), 0 8px 32px 0 rgba(59,130,246,0.13), 0 0 24px 2px rgba(168,85,247,0.14)`,
