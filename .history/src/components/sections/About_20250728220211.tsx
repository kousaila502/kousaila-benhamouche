'use client';Update my `About` React component in a Next.js + Tailwind + Framer Motion portfolio project with the following structure and animations:

1. ✅ Keep the top layout: Profile image on the left, and my story text on the right (2-column layout on desktop, stacked on mobile).  
   - Use fade-up animations on scroll using Framer Motion.
   - Profile image should stay with its rounded-full style and glow effect.

2. ✅ Remove the old "Key Achievements" section completely.

3. ✅ Add a new full-width **Skills Overview** section BELOW the profile + bio, not beside it.  
   - Title: `Skills Overview`  
   - Layout: 3 responsive cards (stack on mobile, horizontal on desktop)  
   - Each card includes:
     - A **photo** (not emoji or icon) related to the skill (e.g., a coding screen for frontend, server room or backend diagram, CI/CD dashboard for DevOps).
     - A bold **skill name**: Frontend, Backend, DevOps.
     - A short 1–2 line description of the skill area.
   - Add hover animation (lift + subtle glow) and scroll animations using Framer Motion.

4. ✅ Add a "💡 Passion & Vision" section underneath the skills:
   ...
   - Animate it with `fade-up` on scroll.

5. ✅ Add a "🚀 What's Next?" section:
...
6. ✅ Use Tailwind CSS for spacing and responsiveness.  
   ✅ Use Framer Motion only for animations.  
   ✅ Do not use any external libraries beyond those already included.  
   ✅ Output the full updated React component code.
