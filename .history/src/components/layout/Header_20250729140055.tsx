    ...
    return (
        ...
        >
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Mobile Menu */}
                <div
                    className={`md:hidden fixed inset-0 bg-black/20 z-40 transition-opacity duration-300 ${isMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible pointer-events-none'
                        }`}
